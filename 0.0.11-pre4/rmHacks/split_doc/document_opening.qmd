    ...
    TRAVERSE [[8397788359424131273]]
        ...
        TRAVERSE [[428051690305612204]][.[[7083194890448]]=[[3136424308533489519]]]
            REBUILD [[329520867991562103]]
                ...
                LOCATE BEFORE ALL
                LOCATE BEFORE { ~&7083121450889&~; } ;  pageNumber >= 0 block
...
;  XXX what is actually intended here??
AFFECT [[8850026134298937527]]
    TRAVERSE [[8397993708429497603]]
        REBUILD [[11689254259907176254]]
            LOCATE BEFORE { ~&7083121450889&~; } ;  not enough free space block ?? maybe incorrect
            INSERT { ~&7082020628281&~.openInSecondDoc = ~&214625660372&~; }
        END REBUILD
    END TRAVERSE
END AFFECT
