AFFECT [[1224665461898798997]]
    TRAVERSE [[8397993708429497603]]
        ...
        TRAVERSE [[5728643844066569666]]
            LOCATE BEFORE ALL INSERT { askForToolbarSwitch: () => ~&15793094956877902211&~.~&6503936152&~.askForToolbarSwitch() }
        END TRAVERSE

        REBUILD [[11332990887960589462]]
            LOCATE BEFORE ALL
            INSERT { ~&15793094956877902211&~.~&6503936152&~.askForToolbarSwitch() }
        END REBUILD
    END TRAVERSE
END AFFECT
