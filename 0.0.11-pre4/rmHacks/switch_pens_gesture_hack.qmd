SLOT rmhConfigProperties
    INSERT {
        property ~&6503679477&~ rmhLastToolsGestureHack: ~&6504329801&~
    }
END SLOT

SLOT rmhConfigAliases
    INSERT {
        property ~&214620122227&~ rmhLastToolsGestureHack: ~&7083272960857&~.rmhLastToolsGestureHack
    }
END SLOT
    ...
    TRAVERSE [[254504370080162629]]
        ...
        INSERT {
            ~&8545339034058226003&~ {
                ...
                ~&233727659172727&~: 1
                ~&495358363329399331&~: ~&6504391364&~.rmhSwitchTools()
            }
        }
    END TRAVERSE
END AFFECT
    ...
    TRAVERSE [[8397993708429497603]]
        LOCATE BEFORE ALL INSERT {
            function togglePens() {
                ...
                ~&5972376&~ (_editingTools.~&7082786471789&~(0).~&6503936152&~ == ~&16536305558369217168&~) {
                    ~&214624950331&~ = _editingTools.~&7082786471789&~(1).~&6503936152&~;
                } ~&6503784146&~ {
                    ~&214624950331&~ = _editingTools.~&7082786471789&~(0).~&6503936152&~;
                }
