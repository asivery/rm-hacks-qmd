...
AFFECT [[17298303916558156758]]
    ...
    TRAVERSE [[254504370080162629]]
        ...
        INSERT {
            ~&8545339034058226003&~ {
                ~&5972374&~: rmhToggleEraser
                ~&8399878573055752961&~: "rmh-toggle-eraser"
                ...
                ~&233727659172727&~: 1
                ~&495358363329399331&~: ~&6504391364&~.rmhToggleEraser()
            }
        }
    END TRAVERSE
END AFFECT
...
AFFECT [[11313888899523275277]]
    TRAVERSE [[8397993708429497603]]
        LOCATE BEFORE ALL INSERT {
            property ~&6502786168&~ previousSelectedPen

            function _selectPen(~&197096108&~) {
                previousSelectedPen = ~&501100168435426133&~;
                ~&501100168435426133&~ = ~&197096108&~;
            }

            function toggleEraser() {
                ~&197091758&~ ~&7082627422347&~ = _editingTools.~&7082786471789&~(3).~&6503936152&~;
                ~&197091758&~ ~&214624950331&~;
                ~&5972376&~ (~&7082627422347&~ == ~&16536305558369217168&~) {
                    ~&214624950331&~ = previousSelectedPen;
                } ~&6503784146&~ {
                    ~&214624950331&~ = ~&7082627422347&~;
                }
                ~&233718999756776&~(~&214624950331&~, ~&233704648923420&~.~&8398583355955217966&~.~&14176254790786929359&~);
                _selectPen(~&214624950331&~);
            }
        }

        REBUILD [[15792870570493648626]]
            LOCATE BEFORE ALL
            REPLACE { ~&6504254477&~.~&501100168435426133&~ = ~&233740416638826&~; } WITH { _selectPen(~&233740416638826&~); }
        END REBUILD
    END TRAVERSE
END AFFECT
