SLOT rmhConfigProperties
    INSERT {
        property ~&6503679477&~ rmhToggleToolbarGestureHack: ~&6504329801&~
    }
END SLOT

SLOT rmhConfigAliases
    INSERT {
        property ~&214620122227&~ rmhToggleToolbarGestureHack: ~&7083272960857&~.rmhToggleToolbarGestureHack
    }
END SLOT
    ...
    TRAVERSE [[254504370080162629]]
        ...
        INSERT {
            ~&8545339034058226003&~ {
                ...
                ~&8399878573055752961&~: "rmh-toggle-toolbar"
...
AFFECT [[1224665461898798997]]
    TRAVERSE [[8397993708429497603]]
        LOCATE BEFORE ALL INSERT {
            signal requireToolbarSet(~&6503679477&~ vis)
    ...
    TRAVERSE [[8397993708429497603]] > [[5728643844066569666]]#[[254547437090201330]]
        ...
        INSERT {
            onToggleToolbar: {
                ~&15793094956877902211&~.~&6503936152&~.requireToolbarToggle();
            }
        }
    END TRAVERSE
END AFFECT
