SLOT rmhConfigProperties
    INSERT {
        property ~&6503679477&~ rmhLastDocumentGestureHack: ~&6504329801&~
    }
END SLOT

SLOT rmhConfigAliases
    INSERT {
        property ~&214620122227&~ rmhLastDocumentGestureHack: ~&7083272960857&~.rmhLastDocumentGestureHack
    }
END SLOT
    ...
    TRAVERSE [[8397993708429497603]]
        LOCATE AFTER ALL INSERT {
            function openLastDocument() {
                ...
                ~&254540341572282132&~.requestOpenDocument(recentDocument)
            }
        }
    END TRAVERSE
END AFFECT
