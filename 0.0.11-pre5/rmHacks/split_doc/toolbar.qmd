...
AFFECT [[1224665461898798997]]
    TRAVERSE ?#[[233745975898428]]
        REPLACE [[5972374]] WITH { ~&5972374&~: _toolbar_templ }
    END TRAVERSE
    REBUILD [[8397993708429497603]]
        LOCATE BEFORE ALL
        REPLACE { ~&233745975898428&~: } WITH { ____toolbar-property____ }
        LOCATE BEFORE ALL
        REPLACE { ~&233745975898428&~ } WITH { ~&6504254477&~.~&233745975898428&~ }
        LOCATE BEFORE ALL
        REPLACE { ____toolbar-property____ } WITH { ~&233745975898428&~: }
    END REBUILD
    TRAVERSE [[8397993708429497603]]
        LOCATE BEFORE ALL
        INSERT {
            property ~&197102514&~ ~&233745975898428&~: ~&6504117156&~
            property ~&214620122227&~ toolbarComponent: toolbarComponent
            property ~&214620122227&~ ~&7842069035455457876&~: ~&7842069035455457876&~
        }
...
AFFECT [[2328484894988065446]]
    ...
    TRAVERSE [[8397788359424131273]]
        LOCATE BEFORE ALL INSERT {
            property ~&6503679477&~ mainDocumentSelected: ~&6504329801&~
            property ~&6503679477&~ toolbarShown: ~&6504329801&~
            property ~&6503679477&~ anyToolbarButtonVisible: (~&15793094956877902211&~.~&233748328658231&~ || rmhDocumentViewSplit.~&233748328658231&~) && !~&15793094956877902211&~.~&6503936152&~?.~&17074068313272002312&~ && !rmhDocumentViewSplit.~&6503936152&~?.~&17074068313272002312&~
    ...
    TRAVERSE [[8397993708429497603]] > [[6502786168]]#[[15549782143769420265]]
        TRAVERSE [[254480451320573660]] > [[233704648923420]]
            REBUILD [[2815617667007525497]]
                LOCATE AFTER STREAM ? { ? INSERT { ~&6504254477&~.requireToolbarSet(~&233745975898428&~.~&7712989577739634&~); }
            END REBUILD
        END TRAVERSE
    END TRAVERSE
END AFFECT
