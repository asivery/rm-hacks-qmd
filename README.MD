...
## Compatibility chart
| Version       | qt-resource-rebuilder |      3.22.0.64    |      3.20.0.92    |      3.17.0.72    |
|  :---:        |        :---:          |       :---:       |       :---:       |       :---:       |
|**0.0.11-pre3**|>= v14-20092025        |:white_check_mark: |        :x:        |        :x:        |
|**0.0.11-pre2**|>= v11-01072025        |        :x:        |:white_check_mark: |        :x:        |
|**0.0.11-pre1**|>= v11-01072025        |        :x:        |        :x:        |:white_check_mark: |
